...
export function UserProfile({ className }: UserProfileProps) {
  const { additionalFields, authClient, avatar, localization } =
  ...
  useEffect(() => {
    // Background session refreshes must not replace an edit in progress.
    if (!session || form.state.isDirty) return;
    form.reset({
