...
type View =
  "studio" | "explore" | "integrations" | "theme" | "settings" | "components";
type Entry = {
  id: string;
  theme: Theme;
  version: number;
...
export function ThemeSpace({
  ...
  const [loaded, setLoaded] = useState(false),
    ...
    [user, setUser] = useState<{ displayName: string } | null>(null),
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const session = await request<{ user: { displayName: string } | null }>(
          "/api/session",
        );
        if (!active) return;
  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        ...
        <div className="header-right">
          ...
          <span
            ...
            title={user ? "Personal workspace" : "Guest workspace"}
          >
            <Paintbrush size={16} />
          </span>
        </div>
      ...
      <main className="main-shell">
        {view === "settings" && <SettingsPage draft={theme} notify={notify} />}
        {view === "components" && (
          <>
          ...
          <>
            ...
            <div className="studio-grid" inert={!loaded}>
              <aside className="panel controls-panel">
                ...
                {controlTab === "type" && (
                  <div className="style-controls">
                    ...
                    <p className="small muted">
                      Font names are exported with system fallbacks. Load your
                      chosen fonts in the consuming app.
                    </p>
                    {[
                      {
                        key: "size",
                  ...
                  <div className="style-controls">
                    ...
                    {theme.parent && (
                      <p className="small muted">
                        ...
                        {theme.parent.author}. Attribution stays in your export.
                      </p>
                    )}
                    <p className="small muted">
              ...
              <section className="preview-column">
                ...
                <PreviewWorkspace theme={theme} mode={appearance} />
                <button
              ...
              <aside className="panel export-panel">
                ...
                <button
                  ...
                  disabled={
                    !selectedCount || !theme.name.trim() || !theme.author.trim()
                  }
                  onClick={() => openExport()}
                >
        ...
        {view === "explore" && (
          <>
            <div className="studio-heading">
              <div>
                <p className="eyebrow">A LITTLE INSPIRATION GOES A LONG WAY</p>
            ...
            <div className="catalog-toolbar">
              ...
              <ThemedSelect
                ...
                options={[
                  "All integrations",
                  ...exportTargets.map((t) => ({ value: t.id, label: t.name })),
                ]}
              />
            </div>
            {catalogError && (
        ...
        {view === "integrations" && (
          <>
            ...
            <div className="collection-note">
              ...
              includes its own installation guide. Browser themes affect browser
              chrome; website content needs its own integration.
            </div>
          </>
        )}
        {view === "theme" && detail && (
      ...
      >
        ...
        {user ? (
          <button
            className="primary-button"
            disabled={publishing || !theme.name.trim() || !theme.author.trim()}
